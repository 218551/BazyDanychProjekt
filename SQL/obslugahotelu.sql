...
--
-- Host: 127.0.0.1
-- Czas generowania: 04 Cze 2019, 11:20
...
BEGIN
   select distinct pokoj.NrPokoju, pokoj.LiczbaMiejsc, pokoj.Pietro, pokoj.TypPokoju, pokoj.CenaPokoju from pokoj, rezerwacja_pokoj,rezerwacja
   WHERE
...
WHERE pobyt.FkKlient=id_klient 
 ...
 INSERT INTO rachunek_pobyt VALUES(z,LAST_INSERT_ID());
  select *from rachunek where FkKlient=id_klient Limit 1;
END$$
...
BEGIN
 ...
 SELECT * FROM rezerwacja WHERE FkKlient=klient and NrRezerwacji=(SELECT max(NrRezerwacji) FROM rezerwacja
    );
END$$
...
(51, '2019-06-03', '2019-06-12', 20, 16, 13),
(52, '2019-06-02', NULL, 10, 30, 17),
(53, '2019-06-01', NULL, 3, 3, 4);
...
(87, '0000-00-00', '0000-00-00', '2019-06-04', 2),
(88, '0000-00-00', '0000-00-00', '2019-06-04', 2),
(89, '0000-00-00', '0000-00-00', '2019-06-04', 2),
(90, '0000-00-00', '0000-00-00', '2019-06-04', 2),
(91, '0000-00-00', '0000-00-00', '2019-06-04', 2),
(92, '2017-10-02', '2017-10-05', '2019-06-04', 2),
(93, '2020-10-02', '2020-10-04', '2019-06-04', 3),
(94, '2019-05-10', '2019-05-15', '2019-06-04', 4);
...
CREATE TABLE `users` (
  ...
  `haslo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `login`, `haslo`, `admin`) VALUES
(1, 'tomekkubat', 'tomek1', 1),
(2, 'sekretarka', 'haslo', 0),
(3, '', '', 0),
(4, 'adam', 'haslo', 0);
...
--
ALTER TABLE `pobyt`
  MODIFY `NrPobytu` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT dla tabeli `pokoj`
--
ALTER TABLE `pokoj`
  MODIFY `NrPokoju` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT dla tabeli `rachunek`
--
ALTER TABLE `rachunek`
  MODIFY `NrRachunku` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT dla tabeli `rezerwacja`
--
ALTER TABLE `rezerwacja`
  MODIFY `NrRezerwacji` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
